...
public class Bezier {
    ...
    public void addNode(float x, float y, float width){
        ...
        mDestination.set(getMid(mNextControl.x, x), getMid(mNextControl.y, y), getMid(mNextControl.percent, width));
        mNextControl.set(x, y, width);
    }
    ...
    public void end() {
        ...
        float w = getMid(mNextControl.percent, mSource.percent);
        mControl.set(x, y, w);
    ...
    private double getW(double t){
        return getWidth(mSource.percent, mDestination.percent, t);
    }
